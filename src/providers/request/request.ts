...
export class RequestProvider {
  ...
  firefriends = firebase.database().ref('/followData');
  myfriends;
  userdetails;
  constructor(public userservice: AuthProvider, public events: Events) {
    
  }

  sendrequest(request: Connreq) {
     var promise = new Promise((resolve, reject) => {
      this.firereq.child(request.recipient).push().set({
